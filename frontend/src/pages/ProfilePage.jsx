        ...
        <Table className="profile-table">
          ...
          <tbody>
            <tr>
              ...
              <td className="profile-table-text">
                {Array.isArray(profileInfo["subjects"])
                  ? profileInfo["subjects"].join(", ")
                  : ""}
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="profile-table-text">
                {Array.isArray(profileInfo["availability"])
                  ? profileInfo["availability"].join(", ")
                  : ""}
              </td>
            </tr>
            <tr>
