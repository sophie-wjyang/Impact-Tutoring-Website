                ...
                <Row xs={1} sm={2} lg={3} className="g-4">
                    <Col>
                        <Card className="resource-card">
                            <Card.Img variant="top" src={KhanAcademyImage} className="resource-card-image"/>
                            <Card.Body className="resource-card-body">
                                <Card.Title className="resource-card-title">Tutor onboarding package</Card.Title>
                                <Card.Text className="resource-card-text">A quick onboarding pdf that will run you through the matching process, lesson plans, sessions, and more. </Card.Text>
                    ...
                    <Col>
                        <Card className="resource-card">
                            <Card.Img variant="top" src={EducationImage} className="resource-card-image"/>
                            <Card.Body className="resource-card-body">
                                <Card.Title className="resource-card-title">Tutor onboarding package</Card.Title>
                                <Card.Text className="resource-card-text">A quick onboarding pdf that will run you through the matching process, lesson plans, sessions, and more. </Card.Text>
                                <Button className="resource-card-button">Visit site</Button>
