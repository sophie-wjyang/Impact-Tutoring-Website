...
VALUES
    ...
    ('Filius', 'Flitwick', 'filius.flitwick@example.com', 'filius789', 11, 'Male', 'Cheshire', ARRAY['Charms'], ARRAY['English'], ARRAY['Wednesday', 'Friday'], 2, 'verified', '2021-01-03');
...
VALUES (10, 5, '{"Quidditch"}', '{"Monday", "Wednesday"}');
VALUES (10, 6, '{"Transfiguration"}', '{"Tuesday", "Thursday"}');
VALUES (11, 4, '{"Defense Against the Dark Arts", "Potions"}', '{"Wednesday", "Friday"}');
VALUES (11, 6, '{"Potions"}', '{"Monday", "Tuesday"}');
VALUES (12, 5, '{"Charms"}', '{"Tuesday", "Wednesday"}');
VALUES (12, 6, '{"Charms", "Arithmancy"}', '{"Wednesday", "Thursday"}');
